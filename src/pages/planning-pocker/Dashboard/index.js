        ...
        <div className="main-div"> 
            <div className="container-head container-fluid">
                <div className="row">
                    ...
                    <div className="backButton"><button className="back-btn" onClick={(ev) => { window.history.back()}}><i class="fa fa-arrow-left" aria-hidden="true"></i></button> <h3>Planning Poker</h3></div>
                    </div> 
                    {
